                 ...
                 <tr style="border-collapse:collapse;"> 
                  <td class="es-m-p20b" width="321" valign="top" align="center" style="padding:0;Margin:0;"> 
                   <table width="100%" cellspacing="0" cellpadding="0" bgcolor="transparent" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:transparent;"> 
                     ...
                     <tr style="border-collapse:collapse;"> 
                      <td bgcolor="transparent" align="center" style="padding:0;Margin:0;padding-left:5px;padding-right:5px;padding-top:0px;"><h2 style="Margin:0;line-height:29px;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;font-size:24px;font-style:normal;font-weight:bold;color:#333333;"><strong>New User Invited</strong></h2></td> 
                     </tr> 
                     <tr style="border-collapse:collapse;"> 
                      <td bgcolor="transparent" align="left" style="padding:20px;Margin:0;padding-bottom:5px;">
                        <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:13px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:26px;color:#333333;">
                            {{-- Hello {{ $firstname }}, this is your invitation to join {{ env('APP_NAME') }} for {{ $company }} --}}
                            {{-- <br></br><br></br>This will be your new home for everything that happens with Point of Success and POSPay, including Gift Cards, Guides, Statements, and More. We are excited to have you are part of our family!
                            <br></br><br></br>Click below to get started and fill out your initial information so we can get you going! --}}
