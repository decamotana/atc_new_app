                 ...
                 <tr style="border-collapse:collapse;"> 
                  <td class="es-m-p20b" width="321" valign="top" align="center" style="padding:0;Margin:0;"> 
                   <table width="100%" cellspacing="0" cellpadding="0" bgcolor="transparent" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:transparent;"> 
                     ...
                     <tr style="border-collapse:collapse;"> 
                      <td bgcolor="transparent" align="center" style="padding:0;Margin:0;padding-left:5px;padding-right:5px;padding-top:0px;"><h2 style="Margin:0;line-height:29px;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;font-size:24px;font-style:normal;font-weight:bold;color:#333333;">Ticket Submission Confirmed</h2></td> 
                     </tr> 
                     <tr style="border-collapse:collapse;"> 
                      <td bgcolor="transparent" align="left" style="padding:20px;Margin:0;padding-bottom:5px;"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:17px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:26px;color:#333333;"><strong>Hello <?php echo $full_name?>: </strong></p></td> 
                     </tr> 
                     <tr style="border-collapse:collapse;"> 
                      <td bgcolor="transparent" align="left" style="padding:20px;Margin:0;padding-bottom:5px;"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:17px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:26px;color:#333333;">We are confirming that we received a new ticket from you with the topic: <?php echo $ticket_subject?>. Your new ticket number is: <strong>#<?php echo $ticket_id?></strong>.</p></td> 
                     </tr>
                     <tr style="border-collapse:collapse;"> 
                      <td bgcolor="transparent" align="left" style="padding:20px;Margin:0;padding-bottom:5px;"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-size:17px;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;line-height:26px;color:#333333;">To view the full ticket or add a reply, please click the button below</p></td> 
                     </tr>    
                     <tr style="border-collapse:collapse;"> 
                      <td align="center" style="Margin:0;padding-left:10px;padding-right:10px;padding-top:20px;padding-bottom:30px;"><span class="es-button-border" style="border-style:solid;border-color:#2CB543;background:#FEC300;border-width:0px;display:inline-block;border-radius:4px;width:auto;"><a href="{{$button_link}}" class="es-button" target="_blank" style="mso-style-priority:100 !important;text-decoration:none;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:roboto, 'helvetica neue', helvetica, arial, sans-serif;font-size:18px;color:#333333;border-style:solid;border-color:#FEC300;border-width:10px 20px;display:inline-block;background:#FEC300;border-radius:4px;font-weight:bold;font-style:normal;line-height:22px;width:auto;text-align:center;">View Ticket</a></span></td> 
                     </tr> 
                     <tr class="es-mobile-hidden" style="border-collapse:collapse;"> 
                   ...
                   <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;"> 
                     <tr style="border-collapse:collapse;"> 
                        <td align="center" style="padding:0;Margin:0;color: white">
                            <small >
                                {{$full_name}} <br>
                                <a href="mailto:{{$email}}" target="_blank" style="color: white!important">{{$email}}</a>
                            </small>
                        </td> 
                     </tr> 
                   </table></td> 
