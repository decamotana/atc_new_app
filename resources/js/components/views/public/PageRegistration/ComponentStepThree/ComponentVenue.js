        ...
        >
            ...
            >
                ...
                >
                    <Select.Option
                        key="1"
                        value="TIER 1 Yearly - $995 (Up to 30 Seats)"
                        data-price="995"
                    >
                        TIER 1 Yearly - $995 (Up to 30 Seats)
                    </Select.Option>
                    <Select.Option
                        key="2"
                        value="TIER 2 Yearly - $3,500 (Up to 75 Seats)"
                        data-price="3,500"
                    >
                        TIER 2 Yearly - $3,500 (Up to 75 Seats)
                    </Select.Option>
                    <Select.Option
                        key="3"
                        value="TIER 3 Monthly - $5,000 (75+ Seats)"
                        data-price="5,000"
                    >
                        TIER 3 Monthly - $5,000 (75+ Seats)
                    </Select.Option>
