...
// import pdfImagePng from "../../../../assets/img/document_image.png";
import pdfImageJpg from "../../../../assets/img/documents.jpg";
import $ from "jquery";

import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faRefresh } from "@fortawesome/pro-regular-svg-icons";

export default function PageResourcesPdf() {
	...
	return (
		<Card className="page-caregiver-resource-pdf" id="PageResourcesPdf">
			<Row gutter={[12, 12]}>
				<Col
					xs={{
						order: 1,
						...
						{dataSourceHigh &&
							dataSourceHigh.map((item, index) => {
								return (
									<List
										key={index}
										className="resource-pdf-list m-t-lg"
											...
											>
												<div className="flex gap20 w-100">
													<div className="pdf">
														<a
															target="new"
															href={apiUrl + "storage/" + item2.file_path}
														>
															<img
																className="pdfImagePng"
																alt="pdfImagePng"
																src={pdfImageJpg}
															/>
														</a>
